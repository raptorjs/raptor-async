...
AsyncErrors.prototype = new Error();

AsyncErrors.prototype.add = function(key, err) {
    this.mapped[key] = err;
};

AsyncErrors.prototype.toMap = function() {
    return this.mapped;
};

AsyncErrors.prototype.toArray = function() {
...
AsyncErrors.prototype.toString = function() {
